...
import { getFirestore, collection, doc, deleteDoc, addDoc, updateDoc, getDocs, getDoc, query, onSnapshot} from 'firebase/firestore';
...
export { db, doc, deleteDoc, collection, addDoc, updateDoc, getDocs, getDoc, query, onSnapshot};  
