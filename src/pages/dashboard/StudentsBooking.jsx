...
function StudentsBooking() {
 ...
 const [selectedButton, setSelectedButton] = useState('Free Test');
 ...
 return (
  <main className="space-y-10">
   ...
   <section className="flex justify-start space-x-14 text-lg">
    <button className={`px-12 py-4 rounded-xl ${selectedButton !== 'Courses' ? 'border-2 border-[var(--Yellow)]' : 'bg-[var(--Yellow)]'}`} onClick={() => handleButtonClick('Courses')}>
     Courses
    </button>
    <button className={`px-12 py-4 rounded-xl ${selectedButton !== 'Free Test' ? 'border-2 border-[var(--Yellow)]' : 'bg-[var(--Yellow)]'}`} onClick={() => handleButtonClick('Free Test')}>
     Free Test
    </button>
    <button className={`px-12 py-4 rounded-xl ${selectedButton !== 'Free Session' ? 'border-2 border-[var(--Yellow)]' : 'bg-[var(--Yellow)]'}`} onClick={() => handleButtonClick('Free Session')}>
     Free Session
    </button>
   </section>
